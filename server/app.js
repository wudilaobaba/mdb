...
app.get('/addData',router.studentCreate.studentAdd);

//删
//单个删除:前端传参 {id:'123456789'}
//批量删除:前端传参 {id:'["13245789","445855225"]'}  注意 id的value为字符串
app.get('/delData',router.rud.delData("school","student"));

//改(单个修改)
//前端传参{id:'xxx',+该条目的其他字段}
app.get('/editData',router.rud.editData("school","student"));

//普通查询
//前端传参 {}或{该字段中的一个或多个key:value}
app.get('/getData',router.rud.getData("school","student"));

//分页查询
//前端传参 {pageSize:10,pageNum:1,+其他字段key:value}
// ps：pageSize每页条目数量，pageNum:当前页码
app.get('/getByPage',router.rud.getByPage("school","student"));
